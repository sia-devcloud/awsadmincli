...
subnet_app1=$(aws ec2 create-subnet --tag-specifications\
 ...
 {Key=Createdby,Value=cli}]" --vpc-id "vpc-08bf9def4c66759e8"\
...
--vpc-id "vpc-08bf9def4c66759e8" --cidr-block "198.168.1.0/24" \
...
--vpc-id "vpc-08bf9def4c66759e8" --cidr-block "198.168.2.0/24" \
...
--vpc-id "vpc-08bf9def4c66759e8" --cidr-block "198.168.3.0/24" \
